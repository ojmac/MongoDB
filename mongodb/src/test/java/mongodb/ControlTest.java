...
class ControlTest {
	...
	public void TestRegistrarCoche() {
		...
		Reparacion rep1 = new Reparacion(coche.getMatricula(), 200, "Cambio retrovisor");
		Reparacion rep2 = new Reparacion(coche.getMatricula(), 1400, "Pintar todo el coche");
		Reparacion rep3 = new Reparacion(coche2.getMatricula(), 500, "Cambio luna delantera");
		Reparacion rep4 = new Reparacion(coche2.getMatricula(), 400, "Recarga A/A");
		Reparacion rep5 = new Reparacion(coche3.getMatricula(), 300, "Cambio aceite y filtros");
		Reparacion rep6 = new Reparacion(coche3.getMatricula(), 1500, "Aleta lateral derecha");
		...
		condA.addMatriculaCoche(coche.getMatricula());
		coche.addConductor(condB.getIdCond());
		condB.addMatriculaCoche(coche.getMatricula());
		
		coche2.addConductor(condB.getIdCond());
		condB.addMatriculaCoche(coche2.getMatricula());
		coche2.addConductor(condC.getIdCond());
		condC.addMatriculaCoche(coche2.getMatricula());
		
		coche3.addConductor(condA.getIdCond());
		condA.addMatriculaCoche(coche3.getMatricula());
		coche3.addConductor(condC.getIdCond());;
		condC.addMatriculaCoche(coche3.getMatricula());
		
		coche.addReparacion(rep1.getId());
		rep1.setMatriculaCoche(coche.getMatricula());
		coche.addReparacion(rep2.getId());
		rep2.setMatriculaCoche(coche.getMatricula());
		
		coche2.addReparacion(rep3.getId());
		rep3.setMatriculaCoche(coche2.getMatricula());
		coche2.addReparacion(rep4.getId());
		rep4.setMatriculaCoche(coche2.getMatricula());
		
		coche3.addReparacion(rep5.getId());
		rep5.setMatriculaCoche(coche3.getMatricula());
		coche3.addReparacion(rep6.getId());
		rep6.setMatriculaCoche(coche3.getMatricula());
