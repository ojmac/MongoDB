...
public class Practica {
	...
	public List<Document> obtenerReparacionesConPrecioMayor(double precioMinimo) {
		return coleccionReparaciones.find(Filters.gt("PVP", precioMinimo)).into(new ArrayList<>());
	}
	...
	public Coche documentToCoche(Document doc) {
		...
		coche.setPermisoCirc(documentToPermiso((Document)doc.get("permisoCirculacion")));
	...
	public Reparacion documentToReparacion(Document doc) {
		...
		rep.setMatriculaCoche(doc.getString("matriculaCoche"));
	...
	public PermisoCirc documentToPermiso(Document doc) {
		...
		permiso.setMatriculaCoche("matriculaCoche");
	...
	public boolean borrarConductor(String idCond) {
		...
		coleccionCoches.updateMany(
			    Filters.eq("conductoresIds", idCond), 
			    Updates.pull("conductoresIds", idCond)
			);
	...
	public boolean borrarPermiso(String numId) {
		...
		PermisoCirc pc = documentToPermiso(buscarPermisoPorId(numId));
		
		borrarCoche(pc.getMatriculaCoche());
	...
	public boolean borrarReparación(int numRep) {
		...
		coleccionCoches.updateMany(Filters.eq("reparacionesIds", numRep), Updates.pull("reparacionesIds", numRep));
